...
import '../../../utils.dart/widget/reusable_classes.dart';
import '../controllers/merchants_personal_info_controller.dart';

class MerchantsPersonalInfoView
    extends GetView<MerchantsPersonalInfoController> {
  const MerchantsPersonalInfoView({Key? key}) : super(key: key);
  @override
              ...
              child: Column(
                children: [
                  TextFormField(
                    ...
                    validator: (value) {
                      return controller.validateCompany(value!);
                    },
                  ),
                  const SizedBox(
                    height: 16,
                  ...
                  CustomRaisedButton(
                    ...
                    onPress: () {
                     controller.checkLogin();
                      Get.toNamed('/merchants-verify-phone');
                    },
                  )
                ],
              ),
